...
ActiveRecord::Schema.define(version: 2020_12_23_050131) do
  ...
  create_table "user_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_management_id"], name: "index_user_addresses_on_purchase_management_id"
  end
  ...
  add_foreign_key "user_addresses", "purchase_managements"
end
